...
class PathApplicationSupportDirectory extends StatefulWidget {
  ...
  PathApplicationSupportDirectory({Key key, @required this.storage}) : super(key: key);
        ...
        child: Column(
          children: <Widget>[
            TextField(
              ...
              decoration: InputDecoration.collapsed(hintText: "Write in ApplicationSupportDirectory")
            ),
            Padding(
              padding: EdgeInsets.all(20.0),
              child: RaisedButton(
