            ...
            slivers: <Widget>[
                    ...
                    child: Container(
                      ...
                      child:Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            FadeAnimation(1, Text(widget.destination.city, style: 
                            ...
                            Row(
                              children: <Widget>[
                                FadeAnimation(1.2,
                                Text(widget.destination.country, style:
              ...
              SliverList(
                ...
                Padding(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    FadeAnimation(1.2, Text(widget.destination.description,
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          showPhoto(image: 'assets/images/hotel1.jpg'),
                          showPhoto(image: 'assets/images/hotel2.jpg'),
